...
successful pre-release CI run `32559057246`; V1.2.0 remains intact as the
preceding release. No V1.3 work has started.
...
hardening is complete at `53d78f30c7e9ff4020179c57e286ad24980df6af`
after human approval and successful push CI run `32474664878` with zero
artifacts. V1.2.0 remains intact as the preceding published release. V1.2.1 is
the current published patch release from
`04e9db33dc0de7529b1599871c58cace6ed9f9e2`, with final successful pre-release
CI run `32559057246`. No V1.3 work has started.
