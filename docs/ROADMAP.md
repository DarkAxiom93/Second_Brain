...
embedding, controlled re-embedding of existing embeddings, and deterministic
read-only maintenance auditing. Planned: maintenance execution, backups,
export/import, and observability.
