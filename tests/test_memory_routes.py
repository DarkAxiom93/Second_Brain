...
def test_memory_paths_and_existing_endpoints_are_registered(
    ...
    assert set(paths) == {
        ...
        "/automation-notifications/{notification_id}/read",
        "/automations/preview",
        "/automations/{automation_id}",
        "/automations/{automation_id}/occurrences",
        ...
        "/connector-accounts",
        "/connector-accounts/{account_id}",
        "/connector-accounts/{account_id}/disable",
        "/connector-accounts/{account_id}/re-enable",
        "/connector-accounts/{account_id}/refresh",
        "/connector-accounts/{account_id}/revoke",
        "/connector-accounts/{account_id}/sync-status",
        "/connector-accounts/{account_id}/refresh-schedule",
        "/connector-refresh-schedules/{schedule_id}",
